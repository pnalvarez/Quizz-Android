...
class QuizQuestionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun selectedOptionView(tv: TextView,
        ...
        defaultOptionsView()
        mSelectedAnswer = selectedOptionNumber
    ...
    private fun didTapSubmit() {
        val question = mQuestionsList!![mCurrentPosition-1]
        if (mSelectedAnswer != question.correctAnswer) {
            answerView(mSelectedAnswer, R.drawable.wrong_option_border_bg)
        } else {
            mCorrectAnswers++
        }
